...
type propsScreenHome = StackScreenProps<PropsStack,'Home'>

export const HomeScreen = ({navigation}:propsScreenHome) => {
    ...
    <ScrollView>
      <View style={{ marginTop: top + 20 }}>
        ...
        <View style={{ height: 440 }}>
          <Carousel
            data={nowPlaying}
            renderItem={({ item,index }) => { return <MoviePoster key={index} navigation={navigation} movie={item}></MoviePoster> }}
            sliderWidth={width}
            itemWidth={300}
            firstItem={1}
