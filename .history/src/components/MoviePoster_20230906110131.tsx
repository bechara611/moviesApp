...
export const MoviePoster = memo(({ movie,height=420,width=300,navigation }: Props) => {
 
    const navigation2:StackNavigationProp<PropsStack> =useNavigation(); 
    ...
    return (
        ...
        onPress={()=>{
            ...
            :
            navigation2.dispatch(CommonActions.navigate('Detail',{movie}))
            }}
        activeOpacity={0.8}
