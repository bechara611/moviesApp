...
export const MovieDetails = ({ cast = [], detalles }: props) => {
    ...
    return (
        ...
        <View style={{ marginHorizontal: 10 }}>
            ...
            <Text style={{color:"#fff"}}>{currency.format(detalles!.budget,{code:'decimal'}) }</Text>
            <Text style={{color:"#fff"}}>{new Intl.NumberFormat('es-419', { style: 'currency', currency: 'USD' }).format(detalles!.budget)}</Text>
